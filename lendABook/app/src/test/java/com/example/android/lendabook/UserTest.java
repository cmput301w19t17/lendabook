...
public class UserTest {
    ...
    public void testEditContactInfo() {
        ...
        assertEquals(19,(long)aUser.getContactInfo().getAge());
    ...
    public void testAddAndDeleteBook() {
        ...
        ContactInfo contactStuff = new ContactInfo("personA",20,new PhoneNo(111,
                111,1111), new CurrAddress("Canada","Alberta",
                "Edmonton","1234 " + "1st street"),"abc@ualberta.ca");

        User aUser = new User("username",contactStuff);
        aUser.addBook(newBook);
        assertTrue(aUser.getBooksOwned().contains(newBook));
        aUser.deleteBook(newBook);
